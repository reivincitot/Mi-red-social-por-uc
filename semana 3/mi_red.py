...
#Quinta interaccion consultamos su direccion
direccion = input("Por favor indicanos la direccion donde vives: ")
ciudad = input("Indicanos la ciudad donde vives: ")
pais = input("Por ultimo indicanos el Pais donde vives: ")
...
print("--------------------------------------------------")
print(nombre,"Tu dirección particular es :", direccion,"de la ciudad de ", ciudad.capitalize(), "ubicada en el Pais de",pais.capitalize())
print("****************************************************************************************************************")
