...
def obtener_mensaje():
    mensaje = input("Ahora vamos a publicar un mensaje. Â¿QuÃ© piensas hoy? ").capitalize()
    return mensaje
...
def guardar_datos_usuario(nombre_archivo, nombre,edad,estatura,sexo,pais,estado):
    with open(nombre_archivo,"w") as archivo_usuario:
        archivo_usuario.write(nombre + "\n")
        archivo_usuario.write(edad + "\n")
        archivo_usuario.write(estatura + "\n")
