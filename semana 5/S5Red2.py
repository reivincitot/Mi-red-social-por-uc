...
def cambiar_usuario():
    change_user = input("Ingrese el nombre del usuario al que desea cambiar: ")
    if os.path.exists(change_user + ".user"):
        user_change=leer_usuario(change_user)
        return user_change

    else:
        print("El nombre ingresado no se encuentra en nuestra base de datos")